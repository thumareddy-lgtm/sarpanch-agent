...
# Telugu translations for all bot responses
TELUGU_RESPONSES = {
    'enter_name': "📝 ఫిర్యాదు నమోదు\n\nమీ పూర్తి పేరు టైప్ చేయండి:",
    'enter_mobile': "📱 మొబైల్ నంబర్ (10 అంకెలు):",
    'select_category': "📂 వర్గం ఎంచుకోండి:\n",
    'describe_problem': "📝 సమస్య వివరించండి:",
    'share_location': "📍 దయచేసి మీ లొకేషన్ షేర్ చేయండి (📎 → Location) లేదా ఊరి పేరు టైప్ చేయండి:",
    'ask_urgency': "⚡ ఎంత అత్యవసరం?\n1️⃣ తక్కువ\n2️⃣ మధ్యస్థం\n3️⃣ ఎక్కువ",
    'invalid_urgency': "⚡ దయచేసి 1, 2, లేదా 3 టైప్ చేయండి:",
    'location_received': "📍 లొకేషన్ అందుకుంది!\n\nగ్రామం: ",
    'voice_received': "🎤 వాయిస్ మెసేజ్ అందుకుంది!\n\n📍 దయచేసి మీ లొకేషన్ షేర్ చేయండి (📎 → Location):",
    'complaint_registered': "✅ ఫిర్యాదు నమోదు చేయబడింది!",
    'ticket_id': "📋 టిక్కెట్ ID: ",
    'name_label': "👤 పేరు: ",
    'category_label': "📂 వర్గం: ",
    'location_label': "📍 లొకేషన్/గ్రామం: ",
    'priority_label': "⚡ ప్రాధాన్యత: ",
    'date_label': "📅 తేదీ: ",
    'map_label': "🗺️ మ్యాప్: ",
    'type_menu': "\n\nమెనూ కోసం *menu* టైప్ చేయండి",
    'complaint_status': "🔍 ఫిర్యాదు స్థితి",
    'certificate_status': "🔍 సర్టిఫికెట్ స్థితి",
    'status_label': "📌 స్థితి: ",
    'filed_label': "📅 నమోదు: ",
    'not_found': "❌ ID కనుగొనబడలేదు.\n\nదయచేసి సరైన ID టైప్ చేయండి.",
    'cert_type': "📋 సర్టిఫికెట్ రకం ఎంచుకోండి:\n",
    'cert_name': "📄 అప్లికెంట్ పూర్తి పేరు:",
    'cert_father': "👨 తండ్రి/భర్త పేరు:",
    'cert_purpose': "📝 ప్రయోజనం (ఉదా: బ్యాంక్ లోన్, కళాశాల ప్రవేశం):",
    'cert_submitted': "✅ సర్టిఫికెట్ అభ్యర్థన నమోదు చేయబడింది!\n",
    'processing_time': "\n\nప్రాసెస్ చేయడానికి 5-7 రోజులు పడుతుంది.",
    'gov_schemes': "📋 ప్రభుత్వ పథకాలు\n\n",
    'active_works': "🛠️ అభివృద్ధి పనులు\n\n",
    'announcements': "📢 ప్రకటనలు\n\n",
    'office_info': "🏛️ పంచాయతీ కార్యాలయం\n\n"
}

ENGLISH_RESPONSES = {
    'enter_name': "📝 Enter your full name:",
    'enter_mobile': "📱 Mobile number (10 digits):",
    'select_category': "📂 Select complaint category:\n",
    'describe_problem': "📝 Describe the problem:",
    'share_location': "📍 Share your location (📎 → Location) or type village name:",
    'ask_urgency': "⚡ How urgent?\n1️⃣ Low\n2️⃣ Medium\n3️⃣ High",
    'invalid_urgency': "⚡ Please reply with 1, 2, or 3:",
    'location_received': "📍 Location received!\n\nVillage: ",
    'voice_received': "🎤 Voice message received!\n\n📍 Please share your location (📎 → Location):",
    'complaint_registered': "✅ Complaint Registered!",
    'ticket_id': "📋 Ticket ID: ",
    'name_label': "👤 Name: ",
    'category_label': "📂 Category: ",
    'location_label': "📍 Location/Village: ",
    ...
    'cert_name': "📄 Applicant full name:",
    'cert_father': "👨 Father's/Husband's name:",
    'cert_purpose': "📝 Purpose (e.g., Bank loan, College admission):",
    'cert_submitted': "✅ Certificate Request Submitted!\n",
    'processing_time': "\n\nProcessing takes 5-7 days.",
    'gov_schemes': "📋 Government Schemes\n\n",
    'active_works': "🛠️ Development Works\n\n",
    'announcements': "📢 Announcements\n\n",
    'office_info': "🏛️ Panchayat Office\n\n"
}

COMPLAINT_CATS_EN = {"1":"Road / Pothole","2":"Water Supply","3":"Electricity","4":"Drainage","5":"Ration Shop","6":"Land Dispute","7":"Other"}
COMPLAINT_CATS_TE = {"1":"రోడ్డు / గుంతలు","2":"నీటి సరఫరా","3":"విద్యుత్","4":"మురుగు కాల్వలు","5":"రేషన్ షాపు","6":"భూ వివాదం","7":"ఇతర"}

CERT_TYPES_EN = {"1":"Income Certificate","2":"Caste Certificate","3":"Residence Certificate","4":"Birth Certificate","5":"Death Certificate","6":"Agriculture Land Certificate"}
CERT_TYPES_TE = {"1":"ఆదాయ ధృవీకరణ పత్రం","2":"కుల ధృవీకరణ పత్రం","3":"నివాస ధృవీకరణ పత్రం","4":"జనన ధృవీకరణ పత్రం","5":"మరణ ధృవీకరణ పత్రం","6":"వ్యవసాయ భూ ధృవీకరణ పత్రం"}

PRIORITY_EN = {"low":"Low","medium":"Medium","high":"High"}
PRIORITY_TE = {"low":"తక్కువ","medium":"మధ్యస్థం","high":"ఎక్కువ"}

STATUS_EN = {"pending":"Pending","in_review":"In Review","in_progress":"In Progress","resolved":"Resolved","rejected":"Rejected","ready":"Ready","processing":"Processing"}
STATUS_TE = {"pending":"పెండింగ్","in_review":"సమీక్షలో","in_progress":"ప్రగతిలో","resolved":"పరిష్కరించబడింది","rejected":"తిరస్కరించబడింది","ready":"సిద్ధంగా ఉంది","processing":"ప్రాసెస్ చేస్తోంది"}

SCHEMES_EN = [("Rythu Bandhu","₹5000/acre/season for farmers"),("PM Awas Yojana","Free house for BPL families"),
...
SCHEMES_TE = [("రైతు బంధు","రైతులకు ఎకరానికి ₹5000/సీజన్"),("పీఎం ఆవాస్ యోజన","బీపీఎల్ కుటుంబాలకు ఉచిత ఇల్లు"),
    ("ఆరోగ్యశ్రీ","సంవత్సరానికి ₹5 లక్షల వరకు ఉచిత వైద్యం"),("కళ్యాణ లక్ష్మి","అమ్మాయి పెళ్లికి ₹1 లక్ష"),
    ("పీఎం కిసాన్","రైతులకు సంవత్సరానికి ₹6000"),("ఎన్ఆర్ఈజీఏ","100 రోజుల ఉపాధి"),("భద్రత","బీపీఎల్ కుటుంబాలకు ఉచిత ఎల్పీజీ")]

def get_menu(ctx): 
    return MENU_TE if ctx.get("lang")=="te" else MENU_EN

def get_complaint_cats(lang):
    return COMPLAINT_CATS_TE if lang == "te" else COMPLAINT_CATS_EN

def get_cert_types(lang):
    return CERT_TYPES_TE if lang == "te" else CERT_TYPES_EN

def get_schemes(lang):
    return SCHEMES_TE if lang == "te" else SCHEMES_EN

def get_priority_text(priority, lang):
    return PRIORITY_TE.get(priority, priority) if lang == "te" else PRIORITY_EN.get(priority, priority)

def get_status_text(status, lang):
    return STATUS_TE.get(status, status) if lang == "te" else STATUS_EN.get(status, status)

# ── BOT REPLY FUNCTION WITH COMPLETE TELUGU SUPPORT ─────────
def bot_reply(user_msg, ctx, media_info=None):
    ...
    if media_info and media_info.get("type") == "voice":
        ...
        if lang == "te":
            return TELUGU_RESPONSES['voice_received'], ctx
        return ENGLISH_RESPONSES['voice_received'], ctx
    ...
    if state == "idle":
        if ml == "1":
            ctx["state"] = "c_name"
            if lang == "te":
                return TELUGU_RESPONSES['enter_name'], ctx
            return ENGLISH_RESPONSES['enter_name'], {"state": "c_name", "lang": lang}
        elif ml == "2":
            cats = "\n".join(f"{k}. {v}" for k, v in get_cert_types(lang).items())
            ctx["state"] = "cert_type"
            if lang == "te":
                return f"📋 {TELUGU_RESPONSES['cert_type']}\n{cats}", ctx
            return f"📋 {ENGLISH_RESPONSES['cert_type']}\n{cats}", ctx
        elif ml == "3":
            ctx["state"] = "track_id"
            if lang == "te":
                return "🔍 *ఫిర్యాదు/సర్టిఫికెట్ స్థితి*\n\nమీ రిఫరెన్స్ ID టైప్ చేయండి:", ctx
            return "🔍 *Track Complaint/Certificate*\n\nEnter your Reference ID:", ctx
        elif ml == "4":
            schemes = get_schemes(lang)
            lines = [f"• {n}: {d}" for n, d in schemes]
            if lang == "te":
                return TELUGU_RESPONSES['gov_schemes'] + "\n".join(lines) + TELUGU_RESPONSES['type_menu'], {"state": "idle", "lang": lang}
            return ENGLISH_RESPONSES['gov_schemes'] + "\n".join(lines) + ENGLISH_RESPONSES['type_menu'], {"state": "idle", "lang": lang}
        elif ml == "5":
            rows = active_works()
            if not rows:
                if lang == "te":
            ...
            if lang == "te":
                return TELUGU_RESPONSES['active_works'] + "\n".join(lines) + TELUGU_RESPONSES['type_menu'], {"state": "idle", "lang": lang}
            return ENGLISH_RESPONSES['active_works'] + "\n".join(lines) + ENGLISH_RESPONSES['type_menu'], {"state": "idle", "lang": lang}
        elif ml == "6":
            ...
            if lang == "te":
                return TELUGU_RESPONSES['announcements'] + "\n".join([f"• {a['title']}: {a['body']}" for a in rows]) + TELUGU_RESPONSES['type_menu'], {"state": "idle", "lang": lang}
            return ENGLISH_RESPONSES['announcements'] + "\n".join([f"• {a['title']}: {a['body']}" for a in rows]) + ENGLISH_RESPONSES['type_menu'], {"state": "idle", "lang": lang}
        elif ml == "7":
            if lang == "te":
                return TELUGU_RESPONSES['office_info'] + f"📍 {VILLAGE_NAME}\nసర్పంచ్: {SARPANCH_NAME}\nమండలం: {MANDAL}\nకార్యాలయ సమయాలు: సోమ-శని 10AM-5PM", {"state": "idle", "lang": lang}
            return ENGLISH_RESPONSES['office_info'] + f"📍 {VILLAGE_NAME}\nSarpanch: {SARPANCH_NAME}\nMandal: {MANDAL}\nOffice Hours: Mon-Sat 10AM-5PM", {"state": "idle", "lang": lang}
        else:
            return get_menu({"lang": lang}), {"state": "idle", "lang": lang}
    ...
    if state == "c_name":
        ...
        if lang == "te":
            return f"నమస్కారం {ctx['c_name']}!\n\n{TELUGU_RESPONSES['enter_mobile']}", {"state": "c_phone", "c_name": ctx["c_name"], "lang": lang}
        return f"Hello {ctx['c_name']}!\n\n{ENGLISH_RESPONSES['enter_mobile']}", {"state": "c_phone", "c_name": ctx["c_name"], "lang": lang}
    ...
    if state == "c_phone":
        ...
        ctx["c_phone"] = msg
        ctx["state"] = "c_cat"
        cats = "\n".join(f"{k}. {v}" for k, v in get_complaint_cats(lang).items())
        if lang == "te":
            return TELUGU_RESPONSES['select_category'] + cats, {"state": "c_cat", "c_name": ctx["c_name"], "c_phone": ctx["c_phone"], "lang": lang}
        return ENGLISH_RESPONSES['select_category'] + cats, {"state": "c_cat", "c_name": ctx["c_name"], "c_phone": ctx["c_phone"], "lang": lang}
    
    # COMPLAINT FLOW - Category
    if state == "c_cat":
        cats = get_complaint_cats(lang)
        if msg not in cats:
            if lang == "te":
        ...
        ctx["state"] = "c_desc"
        if lang == "te":
            return f"📝 వర్గం: {ctx['c_cat']}\n\n{TELUGU_RESPONSES['describe_problem']}", ctx
        return f"📝 Category: {ctx['c_cat']}\n\n{ENGLISH_RESPONSES['describe_problem']}", ctx
    ...
    if state == "c_desc":
        ...
        ctx["state"] = "waiting_for_location"
        if lang == "te":
            return TELUGU_RESPONSES['share_location'], ctx
        return ENGLISH_RESPONSES['share_location'], ctx
    ...
    if state == "waiting_for_location":
        ...
        ctx["state"] = "c_pri"
        if lang == "te":
            return TELUGU_RESPONSES['ask_urgency'], ctx
        return ENGLISH_RESPONSES['ask_urgency'], ctx
    ...
    if state == "c_pri":
        ...
        if msg not in pmap:
            if lang == "te":
                return TELUGU_RESPONSES['invalid_urgency'], ctx
            return ENGLISH_RESPONSES['invalid_urgency'], ctx
        ...
        # Build reply in selected language
        priority_text = get_priority_text(pmap[msg], lang)
        if lang == "te":
            reply = f"✅ *{TELUGU_RESPONSES['complaint_registered']}*\n\n📋 {TELUGU_RESPONSES['ticket_id']}{ref}\n👤 {TELUGU_RESPONSES['name_label']}{rec['name']}\n📂 {TELUGU_RESPONSES['category_label']}{rec['category']}\n📍 {TELUGU_RESPONSES['location_label']}{rec['location']}\n⚡ {TELUGU_RESPONSES['priority_label']}{priority_text}\n📅 {TELUGU_RESPONSES['date_label']}{rec['filed_at']}"
        else:
            reply = f"✅ *{ENGLISH_RESPONSES['complaint_registered']}*\n\n📋 {ENGLISH_RESPONSES['ticket_id']}{ref}\n👤 {ENGLISH_RESPONSES['name_label']}{rec['name']}\n📂 {ENGLISH_RESPONSES['category_label']}{rec['category']}\n📍 {ENGLISH_RESPONSES['location_label']}{rec['location']}\n⚡ {ENGLISH_RESPONSES['priority_label']}{priority_text}\n📅 {ENGLISH_RESPONSES['date_label']}{rec['filed_at']}"
        
        if maps_link:
            if lang == "te":
                reply += f"\n🗺️ {TELUGU_RESPONSES['map_label']}{maps_link}"
            else:
                reply += f"\n🗺️ {ENGLISH_RESPONSES['map_label']}{maps_link}"
        
        if lang == "te":
            reply += TELUGU_RESPONSES['type_menu']
        else:
            reply += ENGLISH_RESPONSES['type_menu']
        
        return reply, {"state": "idle", "lang": lang}
    
    # CERTIFICATE FLOW
    if state == "cert_type":
        certs = get_cert_types(lang)
        if msg not in certs:
            if lang == "te":
                return "దయచేసి 1-6 మధ్య సంఖ్య ఎంచుకోండి:", ctx
            return "Choose 1-6:", ctx
        ctx["cert_type"] = certs[msg]
        ctx["state"] = "cert_name"
        if lang == "te":
            return TELUGU_RESPONSES['cert_name'], {"state": "cert_name", "cert_type": ctx["cert_type"], "lang": lang}
        return ENGLISH_RESPONSES['cert_name'], {"state": "cert_name", "cert_type": ctx["cert_type"], "lang": lang}
    ...
    if state == "cert_name":
        ...
        if lang == "te":
            return TELUGU_RESPONSES['cert_father'], {"state": "cert_father", "cert_type": ctx["cert_type"], "cert_name": ctx["cert_name"], "lang": lang}
        return ENGLISH_RESPONSES['cert_father'], {"state": "cert_father", "cert_type": ctx["cert_type"], "cert_name": ctx["cert_name"], "lang": lang}
    ...
    if state == "cert_father":
        ...
        if lang == "te":
            return TELUGU_RESPONSES['enter_mobile'], {"state": "cert_phone", "cert_type": ctx["cert_type"], "cert_name": ctx["cert_name"], "cert_father": ctx["cert_father"], "lang": lang}
        return ENGLISH_RESPONSES['enter_mobile'], {"state": "cert_phone", "cert_type": ctx["cert_type"], "cert_name": ctx["cert_name"], "cert_father": ctx["cert_father"], "lang": lang}
    ...
    if state == "cert_phone":
        ...
        if lang == "te":
            return TELUGU_RESPONSES['cert_purpose'], {"state": "cert_purpose", "cert_type": ctx["cert_type"], "cert_name": ctx["cert_name"], "cert_father": ctx["cert_father"], "cert_phone": ctx["cert_phone"], "lang": lang}
        return ENGLISH_RESPONSES['cert_purpose'], {"state": "cert_purpose", "cert_type": ctx["cert_type"], "cert_name": ctx["cert_name"], "cert_father": ctx["cert_father"], "cert_phone": ctx["cert_phone"], "lang": lang}
    ...
    if state == "cert_purpose":
        ...
        if lang == "te":
            reply = f"✅ {TELUGU_RESPONSES['cert_submitted']}📋 ID: {ref}\n👤 పేరు: {rec['name']}\n📄 రకం: {rec['type']}{TELUGU_RESPONSES['processing_time']}{TELUGU_RESPONSES['type_menu']}"
        else:
            reply = f"✅ {ENGLISH_RESPONSES['cert_submitted']}📋 ID: {ref}\n👤 Name: {rec['name']}\n📄 Type: {rec['type']}{ENGLISH_RESPONSES['processing_time']}{ENGLISH_RESPONSES['type_menu']}"
        return reply, {"state": "idle", "lang": lang}
    ...
    if state == "track_id":
        ...
        if not rec:
            if lang == "te":
                return f"{TELUGU_RESPONSES['not_found']}{TELUGU_RESPONSES['type_menu']}", {"state": "idle", "lang": lang}
            return f"{ENGLISH_RESPONSES['not_found']}{ENGLISH_RESPONSES['type_menu']}", {"state": "idle", "lang": lang}
        
        st = get_status_text(rec.get("status", ""), lang)
        if ref.startswith("CMP"):
            if lang == "te":
                return f"🔍 *{TELUGU_RESPONSES['complaint_status']}*\n\n📋 ID: {ref}\n👤 పేరు: {rec.get('name', '')}\n📂 వర్గం: {rec.get('category', '')}\n📍 లొకేషన్: {rec.get('location', '')}\n📌 {TELUGU_RESPONSES['status_label']}{st}\n📅 {TELUGU_RESPONSES['filed_label']}{rec.get('filed_at', '')}{TELUGU_RESPONSES['type_menu']}", {"state": "idle", "lang": lang}
            return f"🔍 *{ENGLISH_RESPONSES['complaint_status']}*\n\n📋 ID: {ref}\n👤 Name: {rec.get('name', '')}\n📂 Category: {rec.get('category', '')}\n📍 Location: {rec.get('location', '')}\n📌 {ENGLISH_RESPONSES['status_label']}{st}\n📅 {ENGLISH_RESPONSES['filed_label']}{rec.get('filed_at', '')}{ENGLISH_RESPONSES['type_menu']}", {"state": "idle", "lang": lang}
        
        if lang == "te":
            return f"🔍 *{TELUGU_RESPONSES['certificate_status']}*\n\n📋 ID: {ref}\n👤 పేరు: {rec.get('name', '')}\n📄 రకం: {rec.get('type', '')}\n📌 {TELUGU_RESPONSES['status_label']}{st}\n📅 {TELUGU_RESPONSES['filed_label']}{rec.get('filed_at', '')}{TELUGU_RESPONSES['type_menu']}", {"state": "idle", "lang": lang}
        return f"🔍 *{ENGLISH_RESPONSES['certificate_status']}*\n\n📋 ID: {ref}\n👤 Name: {rec.get('name', '')}\n📄 Type: {rec.get('type', '')}\n📌 {ENGLISH_RESPONSES['status_label']}{st}\n📅 {ENGLISH_RESPONSES['filed_label']}{rec.get('filed_at', '')}{ENGLISH_RESPONSES['type_menu']}", {"state": "idle", "lang": lang}
    ...
    try:
        ...
        if msg_type == "text":
            ...
            if session_data.get("state") == "waiting_for_location":
                ...
                if lang == "te":
                    reply = f"{TELUGU_RESPONSES['location_received']}{detected_village}\n\n{TELUGU_RESPONSES['ask_urgency']}"
                else:
                    reply = f"{ENGLISH_RESPONSES['location_received']}{detected_village}\n\n{ENGLISH_RESPONSES['ask_urgency']}"
                send_whatsapp_message(sender, reply)
            else:
...
# ── DASHBOARD WITH AUDIO PLAYER FOR VOICE MESSAGES ───────────
@app.route("/dashboard")
def dashboard():
    if 'sarpanch_username' not in session:
        return redirect(url_for('login'))
